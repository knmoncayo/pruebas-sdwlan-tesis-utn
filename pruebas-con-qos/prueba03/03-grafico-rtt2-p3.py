...
file_path = '/home/karla/pruebas-img/pruebas-con-qos/prueba03/datos-grafico-rtt.csv'  # Ajusta la ruta según tu ubicación de archivo
...
ax.set_title('Escenario 3: Tiempo de ida y vuelta en función del Tiempo', 
