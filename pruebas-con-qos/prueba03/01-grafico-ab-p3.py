...
file_path = '/home/karla/pruebas-img/pruebas-con-qos/prueba03/datos-grafico-ab.csv'  # Ajusta la ruta según tu ubicación de archivo
...
ax.set_title('Escenario 3: Ancho de Banda en función del Tiempo', 
