...
file_path = '/home/karla/pruebas-img/pruebas-con-qos/prueba03/datos-grafico-delay.csv'  # Ajusta la ruta según tu ubicación de archivo
...
ax.set_title('Escenario 3: Retado de transferencia de paquetes IP en función del Tiempo', 
