...
file_path = '/home/karla/pruebas-img/pruebas-con-qos/prueba02/datos-grafico-pqts-perdidos.csv'  # Ajusta la ruta según tu ubicación de archivo
...
ax.set_title('Escenario 2: Cantidad de Paquetes Perdidos en Función del Tiempo', fontsize=14, weight='bold', color='black', pad=20, loc='center')
