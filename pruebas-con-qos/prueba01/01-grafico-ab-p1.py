...
file_path = '/home/karla/pruebas-img/pruebas-con-qos/prueba01/datos-grafico-ab.csv'  # Ajusta la ruta según tu ubicación de archivo
...
ax.set_title('Escenario 1: Ancho de Banda en función del Tiempo', 
