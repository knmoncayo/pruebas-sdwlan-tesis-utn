...
file_path = '/home/karla/pruebas-img/pruebas-sin-qos/prueba01/datos-grafico5s-rtt2.csv'  # Ajusta la ruta según tu ubicación de archivo
...
ax.set_title('Escenario 1: Tiempo de ida y vuelta en función del Tiempo', 
