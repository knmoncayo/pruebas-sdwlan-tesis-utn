...
file_path = '/home/karla/pruebas-img/pruebas-sin-qos/prueba01/datos-grafico-ab.csv'  # Ajusta la ruta según tu ubicación de archivo
...
ax.set_title('Escenario 1 - sin QoS: Ancho de Banda en función del Tiempo', 
...
ax.set_ylabel('Ancho de Banda [Mbps]', fontsize=12, weight='bold', color='black', labelpad=15)
