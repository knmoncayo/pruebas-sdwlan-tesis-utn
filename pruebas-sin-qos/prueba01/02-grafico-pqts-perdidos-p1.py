...
file_path = '/home/karla/pruebas-img/pruebas-sin-qos/prueba01/datos-grafico-pqts-perdidos-5s.csv'  # Ajusta la ruta según tu ubicación de archivo
...
ax.set_title('Escenario 1: Cantidad de Paquetes Perdidos en Función del Tiempo', fontsize=14, weight='bold', color='black', pad=20, loc='center')
