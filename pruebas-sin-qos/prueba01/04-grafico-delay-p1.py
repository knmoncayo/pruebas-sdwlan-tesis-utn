...
file_path = '/home/karla/pruebas-img/pruebas-sin-qos/prueba01/datos-grafico5s-one-way-delay.csv'  # Ajusta la ruta según tu ubicación de archivo
...
ax.set_title('Escenario 1: Retado de transferencia de paquetes IP en función del Tiempo', 
...
ax.set_ylabel('Retardo de transferencia de paquetes [ms]', fontsize=12, weight='bold', color='black', labelpad=15)
