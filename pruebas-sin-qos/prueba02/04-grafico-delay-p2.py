...
file_path = '/home/karla/pruebas-img/pruebas-sin-qos/prueba02/datos-grafico5s-one-way-delay.csv'  # Ajusta la ruta según tu ubicación de archivo
...
ax.set_title('Escenario 2: Retado de transferencia de paquetes IP en función del Tiempo', 
