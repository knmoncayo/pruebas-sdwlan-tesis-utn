...
file_path = '/home/karla/pruebas-img/pruebas-sin-qos/prueba02/datos-grafico5s-rtt.csv'  # Ajusta la ruta según tu ubicación de archivo
...
ax.set_title('Escenario 2: Tiempo de ida y vuelta en función del Tiempo', 
