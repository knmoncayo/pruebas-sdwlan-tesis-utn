...
file_path = '/home/karla/pruebas-img/pruebas-sin-qos/prueba02/datos-grafico5s-ab.csv'  # Ajusta la ruta según tu ubicación de archivo
...
ax.set_title('Escenario 2: Ancho de Banda en función del Tiempo', 
